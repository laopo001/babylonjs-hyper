...
import PGL, { Sphere, render, Scene, ArcRotateCamera, DirectionalLight, Ground, Enity, HemisphericLight, FreeCamera, Collision, StandardMaterial, ReflectionTexture } from '../src/index';
...
class Root extends Enity<any> {
    ...
    create() {
        return [
            <Sphere cast position={[1, 9, 4.5]} scaling={[1, 1, 1]} segments={16} diameter={2}>
                <Collision type={BABYLON.PhysicsImpostor.SphereImpostor} mass={1} restitution={0.9} onCollide={(self: any, collided) => {
                    // 监听碰撞
