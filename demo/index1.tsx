    ...
    init() {
        ...
        setTimeout(() => {
            ...
            this.append(<Box cast position={[-5, 5, 0]} width={2} height={1} depth={2}>
                ...
                <Cylinder position={[0, 5, 0]} >
                    <Collision mass={10} friction={0} restitution={0.01} onCollide={(self: any, collided: any) => {
        ...
        canvas.addEventListener('mouseup', () => {
            ...
            if (timer) {
                ...
                this.curr.children[0].inst.dispose();
                // setTimeout(() => {
                //     (this.curr.children[0] as any).rebuild();
                // }, 2000)
                // this.gamer.children[0].inst.wakeUp();
                this.gamer.children[0].inst.setLinearVelocity(new BABYLON.Vector3(-1 * level, level, 0));
                this.gamer.children[0].inst.setAngularVelocity(new BABYLON.Vector3(0, 0, 0));
